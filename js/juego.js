...
var instrucciones = [
  "Utilizá las flechas para moverte",
  "Movete por el tablero hasta armar la imagen",
  "la imagen de abajo está de guía",
  "Divertite!"
];
...
function chequearSiGano() {
  ...
  for (var i = 0; i < grilla.length; i++) {
    for (var y = 0; y < grilla[i].length; y++) {
      if (grilla[i][y] == grillaGanadora[i][y]) {
        acumulador++;
      } else {
        return false;
      }
